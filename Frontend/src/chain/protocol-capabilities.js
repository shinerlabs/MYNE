export const FEATURE_REQUIREMENTS = Object.freeze({
  ...
  mining: ['open_round', 'bind_round_randomness', 'record_round_randomness_commit', 'register_miner', 'deploy', 'settle_round_verified', 'claim_receipt', 'refund_receipt', 'claim_myne'],
