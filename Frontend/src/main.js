...
const communityLinks = [
  ...
  // VITE_X_URL can override the official account for a deployment environment.
  `<a class="header-social header-social-x" href="${LINKS.x}" target="_blank" rel="noreferrer" aria-label="MYNE on X">${icon('x')}</a>`,
].filter(Boolean).join('');

const claimPanel = `<section class="claim-panel panel rewards-panel collapsed" aria-label="Rewards">
  <div class="rewards-head"><span class="eyebrow">REWARDS</span><div class="rewards-unclaimed" aria-label="Claimable SOL and MYNE" aria-live="polite"><b><span>${solIcon('rw-eth-mark')} <em id="rw-eth">0.00</em></span><i class="rewards-sep">·</i><span><img src="/myne-token-icon.svg" alt=""/> <em id="rw-unclaimed-gld">0.00</em></span></b></div><button class="rewards-toggle" id="rewards-toggle" type="button" aria-label="Expand rewards" aria-expanded="false" aria-controls="rewards-body">${icon('chevron')}</button></div>
...
document.querySelector('#app').innerHTML = `
  ...
  <main class="landing-page page-view active" data-page="home">
    <section class="landing-hero" aria-labelledby="landing-title">
      ...
      <figure class="landing-assay" aria-label="MYNE mark over the twenty-five-tile mining field">
        ...
        <div class="landing-emblem"><img src="/myne-token-icon.svg" alt="" aria-hidden="true"/></div>
      </figure>
    </section>
  </main>
  ...
  <main class="feature-shell page-view" data-page="referrals">
    ...
    <section class="feature-metrics referral-metrics"><article><span>REFERRED</span><strong>0</strong></article><article><span>ACTIVE</span><strong class="referral-active"><b>0</b><small>/ 0</small></strong></article><article><span>EARNED</span><strong><img src="/myne-token-icon.svg" alt=""/> 0.000</strong></article></section>
  ...
  <main class="feature-shell tokenomics-shell simple-tokenomics page-view" data-page="tokenomics">
    ...
    <section class="value-promises">
      <article class="promise-card promise-mine panel"><span>01</span><div class="promise-icon"><img src="/myne-token-icon.svg" alt=""/></div><div><small>ROUND</small><h2>+${isPremine ? '0.3' : '1'} MYNE / min</h2><p>Split / solo</p></div></article>
      ...
      <article class="promise-card promise-refer panel"><span>04</span><div class="gold-asset-chip"><b>SOL</b><i>${solIcon()}</i></div><div><small>STAKE</small><h2>Earn SOL</h2><p>8% of mining volume</p></div></article>
    </section>
  ...
  <main class="feature-shell about-shell page-view" data-page="about"><header class="feature-hero route-header"><div><span class="eyebrow">PROTOCOL</span><h1>About MYNE.</h1></div></header><div class="about-layout"><aside class="about-nav panel"><span>CONTENTS</span><button class="active" data-about-section="intro">Protocol</button><button data-about-section="mining">Mine</button><button data-about-section="token-flow">Supply</button><button data-about-section="fees">Fees</button><button data-about-section="motherlode">Motherlode</button><button data-about-section="referral-model">Referrals</button><button data-about-section="staking-model">Staking</button><button data-about-section="stats">Stats</button><button data-about-section="addresses">Addresses</button></aside><section class="about-content panel">
    <article class="about-section active" data-about-panel="intro"><span class="eyebrow">01 · PROTOCOL</span><h2>Stake MYNE. Earn SOL every round.</h2><p class="about-lead protocol-lead">8% of all mining volume funds staking rewards in SOL.</p><div class="protocol-yield-banner"><span>ALL MINING VOLUME · EVERY ROUND</span><strong>8% <small>STAKING REWARDS IN SOL</small></strong><p>Standard staking earns 1× pool weight. Permanently burn your MYNE to earn 5× staking weight and increase your proportional share of SOL rewards.</p></div><div class="about-statline protocol-staking-stats"><span><small>STAKING ALLOCATION</small><strong>8% SOL</strong></span><span><small>STANDARD STAKE</small><strong>1×</strong></span><span><small>STAKE + BURN</small><strong>5×</strong></span><span><small>REWARD ASSET</small><strong>SOL</strong></span></div><div class="principle-grid protocol-principles"><div><b>All mining volume</b><p>The 8% staking allocation is calculated from every SOL deployment, including bids placed on losing tiles.</p></div><div><b>Native SOL rewards</b><p>Staking rewards stay in SOL from collection through claim—no reward-token conversion is required.</p></div><div><b>Five-times weight</b><p>Burn-staked MYNE is permanent and receives 5× the pool weight of the same amount in standard staking.</p></div><div><b>Proportional distribution</b><p>Your staking weight relative to the total pool determines your share of staking rewards.</p></div></div><div class="protocol-callout protocol-staking-callout"><b>Built around staking</b><p>Every completed mining round funds staking rewards with 8% of its total deployed SOL.</p></div></article>
    ...
    <article class="about-section" data-about-panel="gold-payouts"><span class="eyebrow">05 · SOL REWARDS</span><h2>Stake MYNE. Earn SOL.</h2><p class="about-lead">8% of all mining volume funds staking rewards in SOL.</p><div class="flow-diagram"><div><span>MINING</span><strong>8% STAKING SOL</strong></div></div><div class="about-statline gold-staker-stats"><span><small>REWARD ASSET</small><strong>SOL</strong></span><span><small>STAKING ALLOCATION</small><strong>8%</strong></span><span><small>STANDARD WEIGHT</small><strong>1×</strong></span><span><small>BURN WEIGHT</small><strong>5×</strong></span></div><div class="about-rule-table"><div><span>Distribution basis</span><strong>Pro rata staking weight</strong><p>Your weight relative to total staking weight determines your share of SOL rewards.</p></div><div><span>Mining source</span><strong>8% of deployed SOL</strong><p>Every round funds the staking reward system from mining volume.</p></div><div><span>Payment</span><strong>Claimable SOL</strong><p>Rewards accrue by staking weight and remain claimable.</p></div></div><div class="protocol-callout"><b>No conversion risk</b><p>Rewards stay in SOL from collection through claim.</p></div></article>
    ...
    <article class="about-section" data-about-panel="referral-model"><span class="eyebrow">07 · REFERRALS</span><h2>Share your link. Earn MYNE.</h2><p class="about-lead">Send someone your referral link. When they open it and connect their wallet, their wallet is permanently linked to you. Each time they claim mined MYNE, you earn 1% of that claim.</p><div class="about-statline"><span><small>YOU EARN</small><strong>1%</strong></span><span><small>THEY RECEIVE</small><strong>90%</strong></span><span><small>EXTRA FEE</small><strong>0%</strong></span><span><small>LINK</small><strong>PERMANENT</strong></span></div><div class="about-rule-table"><div><span>1 · Share your link</span><strong>Invite a miner</strong><p>Copy your unique referral link and send it to them.</p></div><div><span>2 · They connect and mine</span><strong>Their wallet links to you</strong><p>The first valid referral stays with that wallet permanently.</p></div><div><span>3 · You earn when they claim</span><strong>1% of their claimed MYNE</strong><p>Your reward is added to your MYNE rewards when they claim.</p></div></div><div class="worked-example"><span>EXAMPLE · THEY CLAIM 100 MYNE</span><p>They receive <b>90 MYNE</b>. You receive <b>1 MYNE</b>. The remaining <b>9 MYNE</b> rewards miners who have not claimed yet.</p></div><div class="protocol-callout"><b>No extra referral fee</b><p>The referral reward comes from the existing claim fee. If a wallet has no referrer, the 1% goes to the configured administrator wallet.</p></div><button class="primary-feature-action" data-route="referrals">Get your referral link</button></article>
    <article class="about-section" data-about-panel="staking-model"><span class="eyebrow">08 · STAKING</span><h2>Stake. Earn SOL.</h2><p class="about-lead">Choose standard staking at 1× weight or permanently burn the principal for 5× weight. Both earn SOL from the 8% staking allocation.</p><div class="about-statline"><span><small>UNSTAKE QUEUE</small><strong>30 DAYS</strong></span><span><small>STAKING ALLOCATION</small><strong>8% SOL</strong></span><span><small>REWARD ASSET</small><strong>SOL</strong></span><span><small>WEIGHTS</small><strong>1× / 5×</strong></span></div><section class="staking-history about-staking-history" data-staking-chart aria-label="Total MYNE staked over the past 30 days"><header><div><span>STAKED MYNE · 30 DAYS</span><strong data-staking-chart-total>—</strong></div><small>PAST 30 DAYS · ON-CHAIN</small></header><div class="staking-history-plot" data-staking-chart-plot><span>Loading staking history…</span></div><footer><span data-staking-chart-start>—</span><span>NOW</span></footer></section><div class="about-rule-table"><div><span>Standard stake</span><strong>1× pool weight</strong><p>Unstake at any time. The withdrawal request starts a 30-day queue before principal can be claimed.</p></div><div><span>Stake + burn</span><strong>5× pool weight</strong><p>The deposited MYNE is permanently burned and cannot be withdrawn.</p></div><div><span>Motherlode position</span><strong>Automatic 5× burn stake</strong><p>Motherlode MYNE is never liquid: it enters every miner’s permanent burn-staked position automatically when the Motherlode is hit.</p></div><div><span>SOL rewards</span><strong>8% of mining volume</strong><p>Mining volume funds SOL staking rewards, shared by weight and kept claimable.</p></div></div><div class="protocol-callout"><b>SOL stays liquid</b><p>Burn-staked MYNE provides permanent reward weight. SOL earned through staking or a Motherlode remains claimable.</p></div><button class="primary-feature-action" data-route="stake">Open staking</button></article>
...
deployedTokenValue.insertAdjacentHTML('afterend', '<strong class="deployed-usd-value" aria-hidden="true"><span>—</span></strong>');
...
if (mineButton) {
  ...
  mineButton.innerHTML = '<span>MINE</span><i class="mine-button-mark"><img src="/myne-token-icon.svg" alt="MYNE"/></i>';
...
document.querySelector('[data-about-panel="staking-model"] .about-lead').textContent = 'Choose standard staking at 1× weight or permanently burn the principal for 5× weight. Both earn SOL from the 8% staking allocation.';
document.querySelector('[data-about-panel="gold-payouts"] .about-lead').textContent = '8% of all mining volume funds staking rewards in SOL.';
const goldPayoutsAbout = document.querySelector('[data-about-panel="gold-payouts"]');
if (goldPayoutsAbout) {
  goldPayoutsAbout.querySelector('.flow-diagram > div:first-child strong').textContent = '8% STAKING SOL';
  ...
  <dialog class="stake-flex-dialog referral-flex-dialog" id="referral-flex-dialog" aria-labelledby="referral-flex-title">
    <section class="stake-flex-modal">
      ...
      <article class="stake-flex-preview" id="referral-flex-preview">
        ...
        <header><img src="/myne-wordmark-ui.png" alt="MYNE"/></header>
        <div class="stake-flex-hero"><div><span>MYNE EARNED</span><strong><img src="/myne-token-icon.svg" alt=""/><b data-ref-flex-earned>0.000</b></strong><small data-ref-flex-earned-usd>$— value</small></div><aside><span>REFERRALS</span><strong data-ref-flex-count>0</strong></aside></div>
        <div class="stake-flex-stats"><span><small>ACTIVE</small><strong><b data-ref-flex-active>0</b></strong></span><span><small>MYNE VALUE</small><strong><b data-ref-flex-earned-value>$—</b></strong></span><span><small>NETWORK EARNED</small><strong><img src="/myne-token-icon.svg" alt=""/><b data-ref-flex-network>0.000</b></strong></span></div>
...
/* About is protocol documentation. Lead with the defining staking economics, then keep every
   chapter grounded in named parameters, mechanics and constraints. */
if (aboutContent && aboutNav) {
  ...
  const statsMark = (asset) => asset === 'sol'
    ...
    : asset === 'myne' ? '<img src="/myne-token-icon.svg" alt="" aria-hidden="true"/>' : '';
  const statsRow = (key, label, note, asset = '') => `
    <div class="protocol-stat-row unavailable" data-protocol-stat="${key}">
      ...
      <svg class="protocol-stat-chart" viewBox="0 0 112 38" preserveAspectRatio="none" aria-hidden="true"><path class="stat-baseline" d="M3 35H109"/><path data-stat-line/><circle data-stat-last r="2.2" hidden/></svg>
      <span class="protocol-stat-value">${statsMark(asset)}<strong data-stat-value>—</strong></span>
    </div>`;
  const statsGroup = (name, source, rows) => `<section class="protocol-stat-group"><header><h3>${name}</h3><small>${source}</small></header><div class="protocol-stat-list">${rows.join('')}</div></section>`;

  const facts = {
    intro: `
      <span class="eyebrow">01 · PROTOCOL</span><h2>Stake MYNE. Earn SOL every round.</h2>
      <p class="about-lead protocol-lead">8% of all mining volume funds staking rewards in SOL.</p>
      <div class="protocol-yield-banner"><span>ALL MINING VOLUME · EVERY ROUND</span><strong>8% <small>STAKING REWARDS IN SOL</small></strong><p>Standard staking earns 1× pool weight. Permanently burn your MYNE to earn 5× staking weight and increase your proportional share of SOL rewards.</p></div>
      <div class="about-statline protocol-staking-stats"><span><small>STAKING ALLOCATION</small><strong>8% SOL</strong></span><span><small>STANDARD STAKE</small><strong>1×</strong></span><span><small>STAKE + BURN</small><strong>5×</strong></span><span><small>REWARD ASSET</small><strong>SOL</strong></span></div>
      <div class="principle-grid protocol-principles"><div><b>All mining volume</b><p>The 8% staking allocation is calculated from every SOL deployment, including bids placed on losing tiles.</p></div><div><b>Native SOL rewards</b><p>Staking rewards stay in SOL from collection through claim—no reward-token conversion is required.</p></div><div><b>Five-times weight</b><p>Burn-staked MYNE is permanent and receives 5× the pool weight of the same amount in standard staking.</p></div><div><b>Proportional distribution</b><p>Your staking weight relative to the total pool determines your share of staking rewards.</p></div></div>
      <div class="protocol-callout protocol-staking-callout"><b>Built around staking</b><p>Every completed mining round funds staking rewards with 8% of its total deployed SOL.</p></div>`,
    mining: `
    ...
    'gold-payouts': `
      ...
      <p class="about-lead">8% of all mining volume funds staking rewards in SOL.</p>
      <div class="about-statline"><span><small>REWARD ASSET</small><strong>SOL</strong></span><span><small>STAKING ALLOCATION</small><strong>8%</strong></span><span><small>STANDARD WEIGHT</small><strong>1×</strong></span><span><small>BURN WEIGHT</small><strong>5×</strong></span></div>
      <div class="about-rule-table"><div><span>Mining source</span><strong>8% of deployed SOL</strong><p>Every round funds the staking reward system from mining volume.</p></div><div><span>Distribution</span><strong>Pro rata staking weight</strong><p>Rewards are shared according to standard and burn-stake weight.</p></div><div><span>Payment</span><strong>Claimable SOL</strong><p>Rewards accrue by staking weight and remain claimable.</p></div></div>`,
    motherlode: `
    ...
    'referral-model': `
      <span class="eyebrow">07 · REFERRALS</span><h2>Share your link. Earn MYNE.</h2>
      <p class="about-lead">Send someone your referral link. When they open it and connect their wallet, their wallet is permanently linked to you. Each time they claim mined MYNE, you earn 1% of that claim.</p>
      <div class="about-statline"><span><small>YOU EARN</small><strong>1%</strong></span><span><small>THEY RECEIVE</small><strong>90%</strong></span><span><small>EXTRA FEE</small><strong>0%</strong></span><span><small>LINK</small><strong>PERMANENT</strong></span></div>
      <div class="about-rule-table"><div><span>1 · Share your link</span><strong>Invite a miner</strong><p>Copy your unique referral link and send it to them.</p></div><div><span>2 · They connect and mine</span><strong>Their wallet links to you</strong><p>The first valid referral stays with that wallet permanently.</p></div><div><span>3 · You earn when they claim</span><strong>1% of their claimed MYNE</strong><p>Your reward is added to your MYNE rewards when they claim.</p></div></div>
      <div class="worked-example"><span>EXAMPLE · THEY CLAIM 100 MYNE</span><p>They receive <b>90 MYNE</b>. You receive <b>1 MYNE</b>. The remaining <b>9 MYNE</b> rewards miners who have not claimed yet.</p></div>
      <div class="protocol-callout"><b>No extra referral fee</b><p>The referral reward comes from the existing claim fee. If a wallet has no referrer, the 1% goes to the configured administrator wallet.</p></div>
      <button class="primary-feature-action" data-route="referrals">Get your referral link</button>`,
    'staking-model': `
    ...
    stats: `
      ...
      <div class="protocol-stats-meta"><span>ON-CHAIN + INDEXED</span><time data-stats-updated>AWAITING FIRST SNAPSHOT</time></div>
      <svg class="protocol-stats-defs" aria-hidden="true" width="0" height="0"><defs><linearGradient id="protocol-stat-spectrum" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#fff08a"/><stop offset=".38" stop-color="#55e2ff"/><stop offset=".7" stop-color="#8e7cff"/><stop offset="1" stop-color="#ef5bd7"/></linearGradient></defs></svg>
      <div class="protocol-stats-grid">
        ${statsGroup('Market', 'LIVE QUOTES', [
          statsRow('market.mynePrice', 'MYNE price', isPremine ? 'pre-launch reference' : 'MYNE / SOL pool spot'),
          statsRow('market.solPrice', 'SOL price', 'live USD quote', 'sol'),
          statsRow('market.marketCap', 'Market cap', 'current supply × spot'),
        ])}
        ${statsGroup('Mining', 'ALL ROUNDS', [
          statsRow('mining.deployed', 'SOL deployed', 'all-time mining volume', 'sol'),
          statsRow('mining.rounds', 'Mined rounds', 'settled rounds'),
          statsRow('mining.emitted', 'MYNE mined', 'mining emissions', 'myne'),
        ...
        ${statsGroup('Staking', 'POOL STATE', [
          ...
          statsRow('staking.stakers', 'Stakers', 'active positions'),
        ])}
        ${statsGroup('Supply', 'SPL MINT', [
          statsRow('supply.current', 'Current supply', 'mint supply now', 'myne'),
          statsRow('supply.burned', 'MYNE burned', 'permanent supply reduction', 'myne'),
          statsRow('supply.remaining', 'Remaining', 'until hard cap', 'myne'),
          statsRow('supply.max', 'Maximum supply', 'protocol hard cap', 'myne'),
        ])}
      </div>`,
  };
  ...
  const navLabels = {
    ...
    motherlode: 'Motherlode', 'referral-model': 'Referrals', 'staking-model': 'Staking', stats: 'Stats', addresses: 'Addresses',
  };
...
const statsTokenAmount = (baseUnits) => Number(BigInt(baseUnits ?? 0)) / 1e9;
const statsNumber = (value, maximumFractionDigits = 2) => Number(value).toLocaleString(undefined, {
  minimumFractionDigits: 0,
  maximumFractionDigits,
});
const statsUsd = (value) => {
  if (!Number.isFinite(value)) return '—';
  const digits = value > 0 && value < 0.01 ? 4 : 2;
  return `$${value.toLocaleString(undefined, { minimumFractionDigits: digits, maximumFractionDigits: digits })}`;
};
const cumulativeRecent = (total, newestFirst, deltaFor) => {
  const chronological = [...(newestFirst || [])].reverse();
  const deltas = chronological.map((row) => Math.max(0, Number(deltaFor(row)) || 0));
  let running = Math.max(0, Number(total) - deltas.reduce((sum, value) => sum + value, 0));
  return [running, ...deltas.map((delta) => (running += delta))];
};
...
/**
 * About → Stats uses the round index for aggregate mining reads whenever it is available. The
 * chain fallback is authoritative but more expensive, so it is used only when the production
 * index cannot answer. Staking and supply are each one cached account read.
 */
const refreshProtocolStats = async (force = false) => {
  ...
  protocolStatsRequest = (async () => {
    const currentRoundId = (() => {
      try { return BigInt(chain.state.roundId ?? 0); } catch { return 0n; }
    })();
    const roundsRead = (async () => {
      const indexed = await loadIndexedRounds({ page: 0, pageSize: 24, filter: 'all', currentRoundId });
      if (indexed) return { rows: indexed.rows, summary: indexed.summary };
      const fallback = await loadRoundHistory({ page: 0, pageSize: 24, account: null, filter: 'all' });
      return { rows: fallback.rows, summary: fallback.summary };
    })();

    const [roundResult, stakingResult, supplyResult] = await Promise.allSettled([
      roundsRead,
      readStakingMetrics(),
      readSupplyStats(),
    ]);
    const metrics = {};
    const add = (key, value, label, history) => {
      if (!Number.isFinite(Number(value))) return;
      metrics[key] = { value: Number(value), label, history };
    };
    ...
    if (rounds?.summary) {
      ...
      const recent = rounds.rows || [];
      const deployed = statsTokenAmount(summary.deployed);
      const emitted = statsTokenAmount(summary.minted);
      add('mining.deployed', deployed, statsNumber(deployed, 4), cumulativeRecent(deployed, recent, (row) => statsTokenAmount(row.totalWager)));
      add('mining.rounds', summary.mined, statsNumber(summary.mined, 0), cumulativeRecent(summary.mined, recent, (row) => row.resolved && BigInt(row.totalWager ?? 0) > 0n ? 1 : 0));
      add('mining.emitted', emitted, statsNumber(emitted), cumulativeRecent(emitted, recent, (row) => statsTokenAmount(row.bullionForWinners)));
    ...
    if (staking) {
      ...
      add('staking.stakers', staking.stakers, statsNumber(staking.stakers, 0));
    }

    renderProtocolStats(root, metrics);
...
const createStakeFlexCard = async () => {
  ...
  const [wordmark, ethLogo, gldLogo] = await Promise.all(['/myne-wordmark-ui.png', '/solana-mark.svg', '/myne-token-icon.svg'].map(async (src) => {
...
const createStakingStatementPdf = async () => {
  ...
  const [gldLogo, ethLogo] = await Promise.all(['/myne-token-icon.svg', '/solana-mark.svg'].map(async (src) => {
    const image = new Image(); image.src = src; await image.decode(); return image;
  }));
...
const setAboutSection = (name) => {
  ...
  const sectionTitles = {
    ...
    'staking-model': 'Staking', stats: 'Stats', addresses: 'Addresses',
  };
  ...
  <main class="feature-shell swap-shell page-view" data-page="swap">
    ...
    <section class="swap-card">
      ...
      <div class="swap-field">
        ...
        <div class="swap-field-body"><strong id="swap-out">0.000</strong><span class="swap-token static" id="swap-to-token"><img src="/myne-token-icon.svg" alt=""/> MYNE</span></div>
      </div>
...
const renderSwap = () => {
  ...
  document.querySelector('#swap-from-token').innerHTML = fromSol ? `${solIcon()} SOL` : `<img src="/myne-token-icon.svg" alt=""/> MYNE`;
  document.querySelector('#swap-to-token').innerHTML = fromSol ? `<img src="/myne-token-icon.svg" alt=""/> MYNE` : `${solIcon()} SOL`;
...
const paintMyReferralRows = () => {
  ...
  list.innerHTML = myReferralRows.slice(start, start + referralPageSize).map((r) => `
    <div class="my-referral-row">
      ...
      <strong aria-label="MYNE earned for you: ${chain.format.solIcon(r.earned)}"><img src="/myne-token-icon.svg" alt=""/> ${chain.format.solIcon(r.earned)}</strong>
...
const paintLeaderboardRows = () => {
  ...
  list.innerHTML = leaderboardRows.slice(start, start + referralPageSize).map((r, index) => `
    <div class="referral-row${r.addr === me ? ' is-me' : ''}">
      ...
      <strong aria-label="MYNE earned: ${chain.format.solIcon(r.lifetime)}"><img src="/myne-token-icon.svg" alt=""/> ${chain.format.solIcon(r.lifetime)}</strong>
      <a class="round-explorer" href="${explorerAddress(r.addr)}" target="_blank" rel="noreferrer" aria-label="View ${chain.format.short(r.addr)} on Solana Explorer">View ↗</a>
    </div>`).join('');
};
...
const renderReferral = () => {
  ...
  if (metrics) {
    ...
    metrics.querySelectorAll('article strong')[2].innerHTML = `<img src="/myne-token-icon.svg" alt=""/> ${s ? chain.format.solIcon(s.lifetime) : '—'}`;
  }
...
const renderChain = (state) => {
  ...
  deployedUsdcNumber.textContent = deployedUsdText === '—' ? '—' : `$${deployedUsdText}`;
  deployedHeading.dataset.solLabel = `≈${deployedSolText} SOL`;
  deployedHeading.dataset.usdLabel = deployedUsdText === '—' ? '≈—' : `≈$${deployedUsdText}`;
  syncSummaryHoverLabels();
...
window.setInterval(() => {
  ...
  switch (route) {
    ...
    case 'mine':
      ...
      break;
    case 'about':
      if (document.querySelector('[data-about-panel="stats"].active')) void refreshProtocolStats();
      break;
    default:
...
if (tokenPill && tokenMenu) {
  tokenMenu.innerHTML = `
    <div class="token-menu-summary">
      <img src="/myne-token-icon.svg" alt="" aria-hidden="true" />
...
const renderAccountMenu = () => {
  ...
  for (const [label, value] of accountStats()) {
    ...
    if (value.bullion !== undefined) {
      parts.push(`<img class="account-stat-mark" src="/myne-token-icon.svg" alt="MYNE"/> ${chain.format.solIcon(value.bullion)}`);
    }
...
const renderConfirmedMiners = (
  ...
  pageRows.forEach((miner) => {
    ...
    const soloMyneBadge = soloMyneWinner
      ? '<span class="solo-myne-badge" aria-label="Solo MYNE reward"><b aria-hidden="true">+</b><img src="/myne-token-icon.svg" alt=""/></span>'
      : '';
