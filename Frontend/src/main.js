...
document.querySelector('#app').innerHTML = `
  ...
  <main class="feature-shell staking-shell page-view" data-page="stake">
    <header class="feature-hero route-header staking-hero"><div><span class="eyebrow">SOL REWARDS</span><h1>Stake.</h1><p class="staking-hero-subtitle">8% of mining deployment + 3% of MYNE/SOL pool trades.</p></div></header>
    ...
    <section class="staking-calculator panel" hidden>
      <header class="calculator-head"><div><span class="eyebrow">REWARD CALCULATOR</span><h2>Project your stake.</h2><p>SOL from mining deployment and MYNE/SOL trading.</p></div><div class="projection-period" role="group" aria-label="Projection period"><button class="active" data-projection-days="30">30D</button><button data-projection-days="90">90D</button><button data-projection-days="180">180D</button><button data-projection-days="365">1Y</button></div></header>
      <div class="calculator-layout">
        <div class="projection-controls"><label for="calculator-amount"><span>MYNE STAKED</span><small>Revenue-based estimate</small></label><div class="calculator-input"><img src="/gld-icon-transparent.png" alt=""/><input id="calculator-amount" value="150" inputmode="decimal" aria-label="MYNE staking projection amount"/><span>MYNE</span></div><div class="projection-results"><article><span>EST. MINING SOL</span><strong>${solIcon()} <b id="projected-eth">0.300</b></strong><small class="projection-usd" id="projected-eth-usd" aria-label="Estimated mining SOL value in US dollars">$1,035</small></article><article><span>EST. TRADING SOL</span><strong>${solIcon()} <b id="projected-gold">0.368</b></strong><small class="projection-usd" id="projected-gold-usd" aria-label="Estimated trading SOL value in US dollars">$1,233</small></article></div><p class="projection-note">Both estimates settle in SOL. Actual rewards follow mining and MYNE/SOL trading volume.</p></div>
  ...
  <main class="feature-shell about-shell page-view" data-page="about"><header class="feature-hero route-header"><div><span class="eyebrow">PROTOCOL</span><h1>About MYNE.</h1></div></header><div class="about-layout"><aside class="about-nav panel"><span>CONTENTS</span><button class="active" data-about-section="intro">Protocol</button><button data-about-section="mining">Mine</button><button data-about-section="token-flow">Supply</button><button data-about-section="fees">Fees</button><button data-about-section="gold-payouts">Rewards</button><button data-about-section="motherlode">Motherlode</button><button data-about-section="referral-model">Referrals</button><button data-about-section="staking-model">Staking</button></aside><section class="about-content panel">
    ...
    <article class="about-section" data-about-panel="fees"><span class="eyebrow">04 · FEES</span><h2>12% · 10% · 4%</h2><p class="about-lead">Each round retains 12% of miners’ deployed SOL. Claiming and Meteora pool trades use separate fee systems.</p><div class="fee-grid detailed-fees"><div><strong>12%</strong><b>Mining fee</b><p>Taken in SOL from every round deployment and distributed every minute.</p>${isPremine ? `<small><span>8% of deployment</span>SOL rewards for stakers</small><small><span>2% of deployment</span>Buyback and burn</small><small><span>2% of deployment</span>Motherlode</small>` : `<small><span>8% of deployment</span>SOL rewards for stakers</small><small><span>2% of deployment</span>Buyback and burn</small><small><span>2% of deployment</span>Motherlode</small>`}</div><div><strong>10%</strong><b>Claim fee</b><p>Charged only when mined MYNE is claimed.</p><small><span>9% of claim</span>Unclaimed balances</small><small><span>1% of claim</span>Permanent referrer</small><small><span>Supply</span>No new mint</small></div><div><strong>4%</strong><b>Meteora pool fee</b><p>Applied to MYNE/SOL buys and sells at the pool; the fee wallet is withdrawn manually.</p><small><span>Operator funding</span>Deposited to stakers in SOL</small><small><span>Separate reserve</span>Motherlode allocation</small><small><span>Wallet transfers</span>Unaffected</small></div></div><div class="worked-example"><span>1.00 SOL DEPLOYED</span><p><b>0.12 SOL</b> is retained: 0.08 staking · 0.02 buyback and burn · 0.02 Motherlode. No admin fee.</p></div><div class="protocol-callout liquidity-callout"><b>Direct SOL yield</b><p>Mining revenue is distributed on-chain. Meteora fees are withdrawn by the operator and deposited into the staking reward vault.</p></div></article>
    <article class="about-section" data-about-panel="gold-payouts"><span class="eyebrow">05 · SOL REWARDS</span><h2>Stake MYNE. Earn SOL.</h2><p class="about-lead">Stakers receive 7% of mining deployment and 3% of MYNE/SOL pool trades in SOL.</p><div class="flow-diagram"><div><span>MINING</span><strong>7% SOL</strong></div><i>+</i><div><span>POOL TRADES</span><strong>3% STAKERS</strong></div><i>+</i><div><span>MOTHERLODE</span><strong>1% SOL</strong></div></div><div class="about-statline gold-staker-stats"><span><small>REWARD ASSET</small><strong>SOL</strong></span><span><small>MINING SHARE</small><strong>7%</strong></span><span><small>STAKER TRADE SHARE</small><strong>3%</strong></span><span><small>MOTHERLODE TRADE SHARE</small><strong>1%</strong></span></div><div class="about-rule-table"><div><span>Distribution basis</span><strong>Pro rata staking weight</strong><p>Your weight relative to total staking weight determines your share of SOL revenue.</p></div><div><span>Mining source</span><strong>7% of deployed SOL</strong><p>The expanded staking allocation is paid into the SOL reward accumulator every round.</p></div><div><span>Trading source</span><strong>3% of pool trades</strong><p>Stakers receive three quarters of the 4% liquidity pool tax; the remaining 1% funds the Motherlode.</p></div></div><div class="protocol-callout"><b>No conversion risk</b><p>Rewards stay in SOL from collection through claim. There is no stock purchase, basket rotation or secondary reward-token liquidity dependency.</p></div></article>
    <article class="about-section" data-about-panel="motherlode"><span class="eyebrow">06 · MOTHERLODE</span><h2>Two assets. Two destinations.</h2><p class="about-lead">The Motherlode grows in SOL from mining deployments and pool trades, while MYNE accrues every round. On a hit, both assets are shared by every miner in that round in proportion to total deployment.</p><div class="motherlode-grid"><div><strong>+0.2</strong><span>MYNE / round · burn stake</span></div><div><strong>1% + 1%</strong><span>Mining SOL + trade SOL</span></div><div><strong>1 / 650</strong><span>Round odds</span></div></div><div class="motherlode-formula"><div><span>BURNT-STAKED MYNE</span><strong>0.2 × rounds since last hit</strong></div><i>+</i><div><span>CLAIMABLE SOL</span><strong>1% deployed SOL + 1% pool trades</strong></div></div><div class="worked-example"><span>100 ROUNDS WITHOUT A HIT</span><p>Every miner shares the accumulated Motherlode in proportion to total round deployment, including miners who were not on the winning tile.</p></div><div class="protocol-callout"><b>When it hits</b><p>The MYNE is placed directly into each miner’s permanent 5× burn-stake share. The SOL share remains claimable by each miner.</p></div></article>
...
document.querySelector('[data-about-panel="staking-model"] .about-lead').textContent = 'Choose standard staking at 1× weight or permanently burn the principal for 5× weight. Both earn SOL from mining and trading revenue.';
document.querySelector('[data-about-panel="gold-payouts"] .about-lead').textContent = 'Stakers receive 8% of mining deployment and 3% of the MYNE/SOL liquidity pool tax in SOL. The protocol routes the remaining 1% to the Motherlode.';
...
if (motherlodeAbout) {
  motherlodeAbout.querySelector('.motherlode-grid > div:nth-child(2) strong').textContent = '2% + 1%';
  motherlodeAbout.querySelector('.motherlode-formula > div:last-child strong').textContent = '2% deployed SOL + 1% pool trades';
}
...
feeAbout.querySelector('.liquidity-callout p').textContent = 'The 4% trade fee is configured at Meteora. Its fee authority withdraws the SOL manually, then deposits the staking share into MYNE’s on-chain reward vault.';
...
if (aboutContent && aboutNav) {
  ...
  const facts = {
    ...
    fees: `
      ...
      <div class="fee-grid detailed-fees"><div><strong>12%</strong><b>Mining deployment</b><small><span>8%</span>Staker SOL rewards</small><small><span>2%</span>MYNE buyback and burn</small><small><span>2%</span>Motherlode</small></div><div><strong>10%</strong><b>MYNE claim</b><small><span>9%</span>Unclaimed MYNE balances</small><small><span>1%</span>Permanent referrer</small></div><div><strong>4%</strong><b>Liquidity pool tax</b><small><span>3%</span>Stakers by weight</small><small><span>1%</span>Motherlode reward pool</small><small><span>Collection</span>Automatically claimed by protocol</small><small><span>Wallet transfers</span>No fee</small></div></div>`,
    'gold-payouts': `
      <span class="eyebrow">05 · REWARDS</span><h2>SOL staking rewards</h2>
      <div class="about-statline"><span><small>REWARD ASSET</small><strong>SOL</strong></span><span><small>MINING SOURCE</small><strong>8%</strong></span><span><small>STAKER TRADE SHARE</small><strong>3%</strong></span><span><small>MOTHERLODE TRADE SHARE</small><strong>1%</strong></span></div>
      <div class="about-rule-table"><div><span>Mining source</span><strong>8% of deployed SOL</strong><p>Added to the staking reward accumulator every minute.</p></div><div><span>Staker trading source</span><strong>3% of MYNE/SOL pool trades</strong><p>Distributed to stakers according to reward weight.</p></div><div><span>Motherlode trading source</span><strong>1% of MYNE/SOL pool trades</strong><p>Added directly to the Motherlode SOL reward pool.</p></div><div><span>Tax scope</span><strong>Buys and sells only</strong><p>Wallet transfers remain untaxed.</p></div></div>`,
    motherlode: `
      <span class="eyebrow">06 · MOTHERLODE</span><h2>Motherlode SOL + staking bonus</h2>
      <div class="about-statline"><span><small>MYNE ACCRUAL</small><strong>0.2 / ROUND</strong></span><span><small>MINING SOL</small><strong>1%</strong></span><span><small>TRADE SOL</small><strong>1%</strong></span><span><small>HIT ODDS</small><strong>1 / 650</strong></span></div>
      <div class="about-rule-table"><div><span>Staking bonus</span><strong>0.2 MYNE × rounds since the previous hit</strong><p>Always awarded with the Motherlode, then burned and assigned directly to each winner's permanent staking balance.</p></div><div><span>Mining SOL source</span><strong>1% of SOL deployed each round</strong><p>Added to the liquid Motherlode SOL payment balance.</p></div><div><span>Trading SOL source</span><strong>1% of MYNE/SOL buys and sells</strong><p>The Motherlode receives one quarter of the 4% liquidity pool tax.</p></div><div><span>Payment status</span><strong>SOL claimable · MYNE staked</strong><p>The Motherlode SOL remains claimable; the staking bonus is permanently burned and staked to increase reward weight.</p></div></div>`,
    'referral-model': `
...
const renderStakingRewards = () => {
  const s = stakingState;
  // Staker revenue accrues in the same SOL accumulator: 8% of mining deployment plus 3% of
  // MYNE/SOL pool trades. The remaining 1% of the 4% liquidity pool tax funds the Motherlode.
...
const createStakingStatementPdf = async () => {
  ...
  ctx.fillStyle = '#f0f0f0'; ctx.font = '700 28px "DM Sans", sans-serif'; ctx.fillText('8% mining + 3% trading', 86, 1390);
  ...
  ctx.fillStyle = '#74777e'; ctx.font = '500 17px "DM Sans", sans-serif'; ctx.fillText('Rewards vary with mining and trading volume. Values reflect the chain at generation time.', 86, 1668);
...
document.querySelector('[data-page="stake"]').insertAdjacentHTML('afterend', `
  <main class="feature-shell swap-shell page-view" data-page="swap">
    ...
    <section class="swap-card">
      ...
      <div class="swap-info"><span>Liquidity pool tax · 4%</span><b>3% stakers · 1% Motherlode</b></div>
