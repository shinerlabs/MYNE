...
export declare const FORMAT_JSON = 1;
export declare enum MetadataCompression {
    None = 0,
    Gzip = 1,
    Zlib = 2
}
export declare enum MetadataEncoding {
    None = 0,
    Utf8 = 1,
    Base58 = 2,
    Base64 = 3
...
export declare function idlAddress(programId: PublicKey): PublicKey;
export declare function seed(): string;
export declare function decodeIdlAccount<IDL extends Idl = Idl>(data: Buffer): IDL;
export declare function uncompressMetadataData(data: Buffer, compression: MetadataCompression): Buffer;
export declare function decodeMetadataData(data: Buffer, encoding: MetadataEncoding): string;
/**
